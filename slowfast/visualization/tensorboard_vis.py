...
class TensorboardWriter(object):
    ...
    def add_images(self, img_tensor, tag="Image Input", global_step=None, dataformats='HW'):
        ...
        Args:
            ...
            global_step(Optional[int]): current step.
        """
        self.writer.add_images(tag, img_tensor, global_step=global_step)

    def make_grid(self, img_tensor, nrow, padding, normalize=False, scale_each=False, pad_value=2):
        self.writer.make_grid(img_tensor, nrow, padding, pad_value)
