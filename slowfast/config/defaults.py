...
# The path to the split list directory.
_C.DATA.PATH_TO_SPLIT_DIR = ""

# The path to the label directory.
_C.DATA.PATH_TO_LABEL_DIR = ""
_C.DATA.PATH_TO_LABEL_F_DIR = ""
_C.DATA.PATH_TO_LABEL_M_DIR = ""
_C.DATA.PATH_TO_LABEL_L_DIR = ""

# The path to the head motion directory.
_C.DATA.PATH_TO_HEAD_DIR = ""
